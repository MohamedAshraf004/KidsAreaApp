...
{
    public partial class TestForSerial : Migration
    {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReservationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReceiptSerialKey = table.Column<int>(type: "int", nullable: true),
                    ...
                    TotatCost = table.Column<double>(type: "float", nullable: false),
                    CostAfterDiscount = table.Column<double>(type: "float", nullable: false),
